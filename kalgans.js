...
browser: ['TwoBotz Multi Device','Safari','1.0.0'],
auth: state,
version
})
...
let buttons = [
{buttonId: `banghw.☆`, buttonText: {displayText: buttonvirus}, type: 1},
]
let buttonMessage = {
...
let link = `https://youtube.com/c/HwModsWa857`
let buttons = [
{buttonId: `𝐓𝐖𝐎𝐁𝐎𝐓𝐙☆`, buttonText: {displayText: buttonvirus}, type: 1},
]
let buttonMessage = {
document: fs.readFileSync('./baseikal/lib/tes.xlsx'),
mimetype: feler,
